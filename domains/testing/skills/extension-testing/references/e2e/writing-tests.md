...
- [Test i18n Usage Guidelines](../../test-i18n-usage/skill.md) (separate skill)
- [E2E flakiness catalog](flakiness.md) — use when fixing flakes
- [POM anti-patterns](pom-antipatterns.md) — self-check before submit

# Writing Extension E2E tests
