...
| `metamask.wallet.navigate` | `target` | Navigate through wallet-owned areas such as Perps. | navigation proof |
...
| `metamask.perps.navigate` | `target`, optional `market` | Move through Perps domain screens. |
